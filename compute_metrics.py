...
def compute_metrics(denframes, seq_gt, vmaf, vmaf_neg, data_range=1.0):
    ...
    vmaf_val = vmaf(seq_gt_y.cpu(), denframes_y.cpu())
    vmaf_neg_val = vmaf_neg(seq_gt_y.cpu(), denframes_y.cpu())

    return psnr, ssim_v, msssim_v, vmaf_val, vmaf_neg_val


def compute_metrics_on_dataset(input_dir, gt_dir, output_dir):
    ...
    for video in videos:
        ...
        psnr_v, ssim_v, msssim_v, vmaf_v, vmaf_neg_v = compute_metrics(seq, seq_gt, vmaf, vmaf_neg)
...
if __name__ == "__main__":
    ...
    compute_metrics_on_dataset(args.input_dir, args.gt_dir, args.output_dir)